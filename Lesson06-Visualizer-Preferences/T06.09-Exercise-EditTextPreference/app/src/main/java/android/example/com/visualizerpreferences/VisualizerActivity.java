...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setMinSizeScale(sharedPreferences.getFloat((getString(R.string.pref_size_default_value)),
                Float.parseFloat(getString(R.string.pref_size_default_value ))));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            ...
            Float minimumSize = Float.parseFloat(sharedPreferences.getString(key, getString(R.string.pref_size_default_value )));
            mVisualizerView.setMinSizeScale(minimumSize);
        }
    }
