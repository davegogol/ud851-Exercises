...
public class MainActivity extends AppCompatActivity {
        ...
        if(savedInstanceState != null)
            if(savedInstanceState.containsKey(QUERY_URL))
                mSearchResultsTextView.
                        setText(savedInstanceState.getCharSequence(QUERY_RESULTS));
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String queryResults = mSearchResultsTextView.getText().toString();

        outState.putCharSequence(QUERY_URL, urlDisplay);
        outState.putCharSequence(QUERY_RESULTS, queryResults);
